...
if (isset($_POST['product-submit'])) {
    ...
    if ($updateProduct) {
        ...
        echo "<script>alert('Store update failed');</script>";
        echo "<script>window.location.href = '../../views/dashboard.php';</script>";
    }
}
?>
<section id="contact" class="contact" style="background-color: var(--bg-body); padding:100px; padding-top:10px;">
  ...
  <div class="contact__text">
      <h2 class="contact__headline header-xl">Update store</h2>
    </div>
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class=" contact__control align-left">
        <button class="button" name="product-submit" type="submit" style="color: var(--accent);">Update Store</button>
      </div>
    </form>
  </div>
</section>
